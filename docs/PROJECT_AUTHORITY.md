...
- `docs/DOCUMENT_INDEX.md` is navigation only. It is deliberately excluded from document-census inbound-authority calculations, so linking a file there cannot make that file current.
