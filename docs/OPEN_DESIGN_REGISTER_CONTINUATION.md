...
Status: OPEN QUESTIONS + RESOLVED POST-FREEZE INDEX
Updated: 2026-09-06

Blueprint 0.1 remains frozen. ODR-01 through ODR-31 retain their exact frozen wording and status. This file records questions raised after the freeze and links resolved post-freeze items without editing the frozen blueprint.
...
## Resolved post-freeze items

### ODR-33 — Website hero causal-observability burden — RESOLVED 2026-09-06

Director-approved decision:

**The website hero is not required to make one specific earlier human author directly recoverable. It should carry human presence, a changed shared condition, living consequence and altered present possibility. Exact authorship / commit causality belongs to later deterministic causal-cycle and history sections.**
