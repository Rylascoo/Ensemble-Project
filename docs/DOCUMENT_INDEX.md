...
The current consequential engineering gate is the Director-owned Q-E0A-03 route disposition, framed by `CURRENT_STATE.md`, the frozen closure contract, the Run 07 terminal analysis, and `docs/evidence/E0A_Q_E0A_03_POST_FULL_CANDIDATE_ROUTE_DECISION_INPUT_2026_09_11.md`. Runs 03/04/05/06/07 remain immutable/noncontributing. Q-E0A-03 stays open/blocked and provider traffic stays zero until that decision is durable; the route input recommendation is not authority, and the 2.5 control cannot substitute or start automatically.
