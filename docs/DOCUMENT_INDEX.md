...
- `docs/evidence/E0C_Q_E0C_01_TWO_SLOT_PREREGISTRATION_2026_09_12.md` - exact fresh Repeat 1/Repeat 2 RunIds, nonexistent roots/claims, frozen Run 08-identical condition, one-slot consumption law, and no-replacement boundary.
- `docs/evidence/E0C_Q_E0C_01_BLIND_SCORING_INSTRUMENT_2026_09_12.json` - pre-transcript frozen three-pair repeatability instrument with ten-dimension E0 rubric and deterministic runtime-seal-based LEFT/RIGHT mapping law.
