...
- `docs/evidence/E0C_Q_E0C_01_RUN01_PREACTIVATION_2026_09_12.md` - canonical Slot 1 preactivation; public/native/namespace gates pass while fresh authenticated project/key/tier/quota/capacity and exact UTC window freeze remain pending.
...
The current consequential engineering gate is **canonical E0-C Slot 1 activation preparation for `E0C-Q01-IDENT-20260912-01`**. The Director-ratified timing law and dual-preregistration race are reconciled; the earlier `IDENT` batch is canonical and the later `REF` realization is historical only. Fresh authenticated project/key/tier/quota/capacity plus one explicit UTC Slot-1-then-Slot-2 batch window must be frozen and integrated before any namespace claim/provider traffic.
