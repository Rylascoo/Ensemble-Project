...
The current consequential engineering gate is exact Run 08 activation under `CURRENT_STATE.md`, `docs/evidence/E0A_Q_E0A_03_OPTION_A_DIRECTOR_DECISION_2026_09_11.md`, and `docs/evidence/E0A_Q_E0A_03_G35L_RUN08_PREEXECUTION_ACTIVATION_2026_09_11.md`. Runs 03/04/05/06/07 remain immutable/noncontributing. Provider traffic stays zero until Run 08 activation is integrated and post-merge Validation is green; the 2.5 control remains outside Option A.
