...
The current consequential engineering gate is **E0-C post-batch blind repeatability comparison**. Both fresh slots are consumed and sealed: Slot 1 contributes at 12/12; Slot 2 is noncontributing at 0/12 after `InvalidOutput`. Frozen eligibility leaves only `E0C-P01` (Run 08 vs Slot 1). Construct the cryptographically randomized LEFT/RIGHT mapping and blind package, commit the mapping hash before scorer access, seal ten-dimension scores/evidence before reveal, then unblind and close Q-E0C-01. Provider traffic remains zero.
