...
- `docs/blueprint/E0C_REPEATED_IDENTICAL_CONDITION_METHOD_PROPOSAL_01.md` - current E0-C method proposal: two fresh preregistered repeats of the selected Run 08 condition from exact Run 08 executable, zero source change/retry/replacement, independent seals/hard gates, and frozen blind pairwise repeatability comparison; Director approval required.
- `docs/evidence/E0C_Q_E0C_01_PREPARATION_AUDIT_AND_DIRECTOR_INPUT_2026_09_12.md` - recursive E0-C preparation audit and Director input; verifies exact Run 08 validator reuse, no source amendment, bounded two-repeat recommendation, anti-selection rules, and the remaining execution-time authority gates.
- `docs/evidence/E0C_Q_E0C_01_METHOD_DIRECTOR_DECISION_2026_09_12.md` - Director approval of exactly two fresh preregistered identical-condition repeats from exact Run 08 executable; authorizes preregistration/instrument/activation preparation only and creates no provider execution authority.
- `docs/evidence/E0C_Q_E0C_01_BLIND_REPEATABILITY_INSTRUMENT_2026_09_12.json` - frozen pre-transcript E0-C pairwise repeatability rubric/instrument; fixes batch pair set, eligibility, blinding, mapping-seal procedure, and no-master-score/no-significance law.
- `docs/evidence/E0C_Q_E0C_01_TWO_SLOT_PREREGISTRATION_2026_09_12.md` - fixes both fresh RunIds/evidence-root identities before first execution; roots/claims remain absent and no retry/replacement slot exists.
- `docs/evidence/E0C_Q_E0C_01_PUBLIC_FACT_AUDIT_2026_09_12.md` - current public 3.5 Flash-Lite model/lifecycle/thinking/pricing/data-use/rate-limit audit supporting preactivation; authenticated account/capacity remains separate.
- `docs/evidence/E0C_Q_E0C_01_RUN01_PREACTIVATION_2026_09_12.md` - exact Slot 1 preactivation binding Run 08 executable, frozen instrument, absent namespace, and public facts; fresh authenticated current project/tier/quota/capacity remains the blocking execution-time gate.
...
The current consequential engineering gate is **Q-E0C-01 Run 01 authenticated current project/tier/quota/capacity confirmation and exact activation**. Both fresh slots are already preregistered and the blind instrument is frozen; Slot 1 public/native/namespace preactivation passes. No provider probe or execution is authorized, and Slot 2 remains independently planned behind Slot 1 terminal preservation.
