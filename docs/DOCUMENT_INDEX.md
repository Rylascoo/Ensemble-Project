...
The current consequential engineering gate is **Q-E0C-01 exact two-slot preregistration / frozen blind instrument / activation preparation**. The Director approved exactly two fresh repeats from exact Run 08 executable `bb869fb...`; no source change, retry, or replacement is authorized. Provider traffic remains zero and each fresh slot requires its own current execution-time gates before launch.
