...
The current consequential engineering gate is integration of the exact preexecution activation for reserved Run 01 `E0B-Q01-MIX-20260912-01`. Authenticated project/testing-key Free tier plus both 3.5/3.1 RPM/input-TPM/RPD/capacity gates now pass; provider traffic remains blocked until this activation is integrated and exact-main post-merge Validation is green. Then exactly one reserved execution is next. Run 08 remains the selected E0-A reference; Run 09 remains terminal/noncontributing and non-replayable.
