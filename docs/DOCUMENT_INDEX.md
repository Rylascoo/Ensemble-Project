...
- docs/evidence/E0B_Q_E0B_01_RUN01_PREACTIVATION_2026_09_12.md - reserved Run 01 boundary binding exact native executable, fresh root, frozen rubric, public/native/credentialless gates; authenticated AI Studio two-route gate remains the sole execution blocker.
...
The current consequential engineering gate is the authenticated AI Studio two-route account/quota/capacity check for reserved Run 01 `E0B-Q01-MIX-20260912-01`. Public/native preactivation is frozen above; provider traffic remains blocked until a separate exact preexecution activation records the intended project/testing-key Free tier plus current 3.5 and 3.1 RPM/input-TPM/RPD rows/capacity, is integrated, and post-merge Validation is green. Run 08 remains the selected E0-A reference; Run 09 remains terminal/noncontributing and non-replayable.
