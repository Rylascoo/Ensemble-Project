...
The current consequential engineering gate is **Director disposition of consumed/noncontributing E0-B Run 01 `E0B-Q01-MIX-20260912-01`**. The single authorized execution reached two accepted turns and then terminated on Turn 3 WREN Performer HTTP 503 / `UNAVAILABLE`; its sealed evidence is immutable and no retry/replacement/provider probe is authorized. Engineering Sol recommends closing E0-B on the preserved result and advancing to Q-E0C-01. Until a Director disposition is durable, provider traffic is zero and Q-E0C-01 remains blocked. Run 08 remains the selected E0-A reference; Run 09 remains terminal/noncontributing and non-replayable.
