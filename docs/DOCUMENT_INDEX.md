...
The current consequential engineering gate is defined by `CURRENT_STATE.md`, the Q-E0A-03 closure contract, the Run 07 terminal analysis, and the promoted native-validated technical-failure diagnostic checkpoint. Runs 03/04/05/06/07 are immutable/noncontributing. Neither 3.5 nor 3.1 produced a contributing full reference; Q-E0A-03 therefore remains open/blocked and provider traffic stays zero until the separately audited Director correction/route decision required by the frozen closure contract is durable. The 2.5 control cannot substitute or start automatically.
