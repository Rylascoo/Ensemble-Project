...
- docs/evidence/E0B_Q_E0B_01_RUN01_PREEXECUTION_ACTIVATION_2026_09_12.md - exact Run 01 activation: authenticated Kymaean project/testing-key Free-tier association plus current 3.5/3.1 quota/capacity evidence match the validated executable; traffic remains blocked until activation integration and green post-merge Validation.
