...
E0-D method/preregistration preparation is **frozen and complete**. The current consequential engineering gate is separate authorization for experiment-only E0-D implementation and its deterministic isolation/native Windows ARM64 validation. No RunIds/windows/provider traffic/credentials/spend are authorized. E0-C remains durably closed and Run 08 remains selected reference.
