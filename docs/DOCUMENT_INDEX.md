...
- `docs/evidence/E0C_Q_E0C_01_P01_BLIND_PACKAGE_2026_09_13.json` - source-neutral 12-turn LEFT/RIGHT package for the sole otherwise-eligible E0-C repeatability pair; contains no run/model/provider metadata and preserves runtime-blinded SPEAKER identities; withheld from scorer pending Director disposition.
- `docs/evidence/E0C_Q_E0C_01_P01_MAPPING_COMMITMENT_2026_09_13.json` - pre-scorer cryptographic commitment to the withheld P01 LEFT/RIGHT mapping; exact mapping remains outside Git; preserved but not usable before Director disposition.
- `docs/evidence/E0C_Q_E0C_01_SLOT2_EXECUTION_LAW_PROTOCOL_DEVIATION_DIRECTOR_INPUT_2026_09_13.md` - successor reconciliation: confirms the missing fresh post-Slot-1 authenticated capacity observation, corrects Slot 1 claim-history prose, preserves P01 package/mapping with zero scorer access, and places E0-C on Director hold.
...
The current consequential engineering gate is **E0-C protocol-deviation Director disposition**. Both fresh namespaces are consumed; Slot 1 contributes and Slot 2 is noncontributing. PR #121 prepared P01 blind artifacts and PR #122 sanitized the package before this deviation reconciliation reached `main`; no scorer access occurred and the mapping remains withheld. Preserve those artifacts without scoring/reveal until the Director either permits P01 under the frozen law or closes E0-C without experiential scoring.
