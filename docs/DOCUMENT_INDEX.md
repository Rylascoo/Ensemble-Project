...
The current consequential engineering gate is Option A replacement preregistration/activation under `CURRENT_STATE.md` and `docs/evidence/E0A_Q_E0A_03_OPTION_A_DIRECTOR_DECISION_2026_09_11.md`. Runs 03/04/05/06/07 remain immutable/noncontributing. Exactly one fresh 3.5 Standard/Free replacement may be activated; provider traffic stays zero until its exact activation and current gates are durable. The 2.5 control remains outside this approval.
