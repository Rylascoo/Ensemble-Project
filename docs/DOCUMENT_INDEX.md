...
The current consequential engineering gate is **Director decision on the prepared Q-E0C-01 repeated-identical-condition method**. The proposal recommends exactly two fresh preregistered repeats of selected Run 08 using exact Run 08 executable `bb869fb...`, with zero source change/retry/replacement and frozen blind pairwise repeatability scoring. No E0-C RunId/root exists yet and provider traffic remains zero. Approval, modification, or rejection must be durable before exact preregistration/activation work proceeds.
