...
The current consequential engineering gate is **Q-E0C-01 non-provider repeated-identical-condition method/preregistration preparation**. Option A closed E0-B on preserved noncontributing Run 01 `E0B-Q01-MIX-20260912-01`; no replacement, replay, partial scoring, or unblinding is authorized. E0-C must return to the selected E0-A same-model Run 08 reference configuration, but repetition count, fresh RunIds/roots, exact executable, scoring/comparison law, and execution-time provider gates are not yet frozen. Provider traffic remains zero until a separate E0-C activation/authority satisfies current law.
