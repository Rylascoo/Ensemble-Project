...
- docs/blueprint/E0B_MIXED_MODEL_CAST_METHOD_PROPOSAL_01.md - current Q-E0B-01 mixed-cast method proposal; recommends one fixed VOSS 3.1 Performer recast against the sealed Run 08 3.5 reference while preserving all other feasible variables; Director decision required before implementation.
...
- docs/evidence/E0B_Q_E0B_01_PREPARATION_AUDIT_AND_DIRECTOR_INPUT_2026_09_12.md - current E0-B non-provider preparation audit; proves the existing single-profile Harness cannot represent mixed casting truthfully, rejects 2.5 from the proposed condition, and presents the recursively audited 3.5/3.1 single-recast Director input.
...
The current consequential engineering gate is the Q-E0B-01 Director cast/method decision under `CURRENT_STATE.md`, `docs/blueprint/E0B_MIXED_MODEL_CAST_METHOD_PROPOSAL_01.md`, and `docs/evidence/E0B_Q_E0B_01_PREPARATION_AUDIT_AND_DIRECTOR_INPUT_2026_09_12.md`. Run 08 is the selected E0-A reference; Run 09 is terminal/noncontributing 2.5 control evidence and is not replayable. No E0-B source implementation or provider traffic is authorized until the Director decision is durable; live execution later requires its own current activation and applicable provider gates.
