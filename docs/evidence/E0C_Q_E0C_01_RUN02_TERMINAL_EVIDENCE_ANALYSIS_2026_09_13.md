...
- `E0C-P01`: selected reference Run 08 vs contributing Slot 1 — **eligible**;
- `E0C-P02`: Run 08 vs Slot 2 — **removed because Slot 2 is noncontributing**;
- `E0C-P03`: Slot 1 vs Slot 2 — **removed because Slot 2 is noncontributing**.
