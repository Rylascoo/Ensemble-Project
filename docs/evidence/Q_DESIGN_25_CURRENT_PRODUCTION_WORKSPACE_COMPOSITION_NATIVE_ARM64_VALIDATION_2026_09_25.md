# Q-DESIGN-25 Current Production workspace composition — native ARM64 validation
...
The prior button-only Current Production overview is composed as one continuous Production workspace using only already-earned open Production identity, `ProductSpace`, World truths, Production Cast, established Scenes/initial rosters and existing uncertainty/return behavior. Preview disclosure is capped at three items per section and never changes identity scope or Product truth.

Recursive audit corrections were bounded to: narrow first-viewport hierarchy; exact World-empty copy; World/Character nonconfirmation honesty; Scene roster Character-code refresh after confirmed duplicate Character creation; and uncertainty-aware empty Scene wording.

## Exact native ARM64 evidence

SurfSeven / Windows ARM64 / .NET SDK 10.0.400:

- focused `Kymaean.Windows.Presentation.Tests`: **17/17 PASS**
- ordinary WinUI Release `win-arm64`: **PASS, 0 warnings / 0 errors**
- Director Preview tests: **8/8 PASS**
- Application: **92/92 PASS**
- Persistence: **153/153 PASS**
- Core: **628/628 PASS**
- Harness: **155/155 PASS**
- Director Preview WinUI Release ARM64: **PASS, 0 warnings / 0 errors**
- ordinary WinUI Release ARM64 in Preview gate: **PASS, 0 warnings / 0 errors**
- Preview Profiles build: **PASS, 0 warnings / 0 errors**
- ordinary/Preview compilation boundary: **PASS**
- exact-source Preview refresh: **PASS**, source `a05f00e64d16a5bc13bd1def03912472fd62c25b`

Preview build receipt hash: `1494C88BAB0B9E98054E8ACDE63DA60427268859E628C3AEE6E12712379561FE`.

## Native visual evidence

Exact-a05 Director Preview captures:

| Capture | SHA-256 |
|---|---|
| Light 1200×800 | `98239CA33AB223E5C3C7AEB847BFB6174D1A7A19DBE2AECB6C0C7BF57E2FB777` |
| Light 720×520 | `CEC1F98AB135FD6207772A2588F8E45AF828AFD810ECFE034490A09E9E87683F` |
| Dark 1200×800 | `B39EDD5F8639C388FA39BB86A43BBA17B29AC4FEBD334B1537610D254A1217A4` |
| Dark 720×520 | `877B05DA1A6DEC50A04D36D21670DAE763142331BA2153DEA760673689A8614C` |
| Dark empty 1200×800 | `AA9232D6CAF282383E951655144D5C76417497AB6723100DAAB6784E12C70E00` |
| Dark empty 720×520 | `F814DF29C4AE2D8238052D2449F206A51545324AFE9CDACF1902255F2F6648BC` |

These establish native composition/theme/viewport evidence only. They do not establish human comprehension, screen-reader delivery, Narrator intelligibility or exact-source High Contrast PASS.
