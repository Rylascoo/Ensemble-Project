...
Browser Developer Mode may be used by Codex for development/browser validation when enabled. It can inspect browser page/DOM state, console/network behavior, and other CDP-visible browser facts.
