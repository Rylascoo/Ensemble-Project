...
|---|---|---|---|---|---|
| Q-E0A-01 | Engineering | DONE | Implement the bounded Gemini provider-error/request-compatibility diagnostic amendment on `e0a-gemini-bounded-provider-error-diagnostic`. | No credential use, provider request, inference, spend, E0-A rerun, 3.1 execution, or `main` merge without the applicable authority. | Closed at machine-tested checkout `e6e7d6c8c7187a87df2c97f2373dd3adbee7ce4a`; Windows ARM64 Core 622/622, Harness 130/130, build/smokes/credentialless PASS; annotated validation tag `validation/e0a-gemini-bounded-provider-error-diagnostic-native-arm64`. Successor Q-E0A-02 is ACTIVE only under its exact Attempt 04 authorization. |
| Q-E0A-02 | Engineering / Director | ACTIVE | Execute exactly one fourth real synthetic Missing Raft `GEMINI-3.5-FLASH-LITE-MINIMAL` E0-A attempt and preserve the terminal compatibility evidence. | Exact Director authorization `docs/evidence/E0A_GEMINI35_ATTEMPT04_DIRECTOR_AUTHORIZATION_2026_09_09.md`; machine-tested executable `e6e7d6c8c7187a87df2c97f2373dd3adbee7ce4a`; current quota decision; all frozen rate/spend/privacy/evidence/timeout/cleanup preconditions. One attempt per role invocation, zero retries, no fallback or unrelated provider traffic. | A provider-contact terminal result consumes the one-run authorization. Durable evidence either validates a usable E0-A route or narrows/falsifies it; provider authorization returns to NONE before any successor decision. |
