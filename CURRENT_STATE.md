...
- Patch 0001a has static review only until rebuilt on the target ARM64 machine.
...
Build and run the existing runtime sanity check from `h1-hygiene-baseline`. If clean, merge Patch 0001a and begin Patch 0002.1: typed E0 Fixture Dialect v1 plus generic semantic validation and tests.
