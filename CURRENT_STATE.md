...
Q-DESIGN-24 is DIRECTOR-ADOPTED. Task A failed at presentation/discoverability before Scene-code sufficiency was tested. Approved Design correction uses existing roster truth. Next: corrected native Task A rerun; Design acceptance withheld; verdict INCONCLUSIVE. Contract: `docs/design/app/contracts/SCENE_INITIAL_ROSTER_PRESENTATION.md`; evidence: `docs/evidence/Q_DESIGN_24_WINDOWS_EMPIRICAL_EVIDENCE_2026_09_23.md`. No merge, Product schema change or Q-PROD-09.
