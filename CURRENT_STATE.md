...
## Continuity
The validated E0-B Harness hard-pins VOSS Performer to Gemini 3.1 Flash-Lite Minimal while MARLOWE/WREN Performers, Integrity, and Interpreter remain on Run 08 3.5 assignments. It records exact per-Character/per-route provenance/model identity/quota/cost, conservative shared-project pacing, one USD 5 ceiling, and preserves Core and all matched Run 08 semantics.
