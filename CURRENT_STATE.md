...
Q-DESIGN-06 is DONE and Q-DESIGN-07 ACTIVE in `docs/PROJECT_EXECUTION_QUEUE.md`; those are design-lane sequencing only and change no engineering checkpoint, validation rung, provider authorization, or E0 order.
